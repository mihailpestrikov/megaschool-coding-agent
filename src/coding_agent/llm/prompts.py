...
- Если добавляешь/меняешь функциональность - обнови или добавь тесты
...
4. Если добавлена новая функциональность - есть ли тесты?
...
- Если нужны тесты — добавь или обнови их
